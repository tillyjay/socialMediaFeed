...
<head>
    ...
    <title>{{ config('app.name', 'SocialMedia Feed') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'SocialMedia Feed') }}
                </a>
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                @if (Auth::check() && Auth::user()->hasRole('User Administrator'))
                                    <a class="nav-link" style href="{{route('users.index')}}">{{ __('Manage Users') }}</a>
                                @endif
                            </li>

                            @if(Auth::user()->isThemeManager())
                            <li class="nav-item">
                                    <a class="nav-link" style href="{{route('themes.index')}}">{{ __('Manage Themes') }}</a>
                            </li>
                            @endif
